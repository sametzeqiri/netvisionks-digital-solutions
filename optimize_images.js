...
async function optimize() {
    ...
    const targets = [
        ...
        { src: 'public/logo-transparent-v5.png', dest: 'public/logo-transparent-v5.webp', quality: 75 },
        { src: 'public/logo-transparent-v5.png', dest: 'public/logo-small.webp', width: 100, quality: 75 },
        { src: 'public/hero-bg-1.jpg', dest: 'public/hero-bg-1.webp', width: 1200, quality: 65 },
        { src: 'public/hero-bg-2.jpg', dest: 'public/hero-bg-2.webp', width: 1200, quality: 65 },
        { src: 'public/hero-bg-3.jpg', dest: 'public/hero-bg-3.webp', width: 1200, quality: 65 },
