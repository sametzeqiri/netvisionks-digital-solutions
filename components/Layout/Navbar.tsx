    ...
    <header className={`fixed w-full z-40 top-0 left-0 transition-all duration-300 ${showSolidNav
      ...
      <div className={`hidden md:block overflow-hidden transition-all duration-300 h-10 opacity-100 py-2 bg-primary text-white text-sm font-medium`}>
        <div className="container mx-auto px-4 lg:px-12 flex justify-between items-center h-full font-sans">
          <div className="flex items-center space-x-6">
            ...
            <a href="tel:08-1234567" className="flex items-center gap-2 hover:text-gray-200 transition-colors"><Phone size={14} className="text-white" /> 08-123 45 67</a>
      ...
      <nav className={`container mx-auto px-4 lg:px-12 flex justify-between items-center transition-all duration-300 ${scrolled ? 'py-4' : 'py-6'}`}>
        ...
        <Link to="/" className={`flex items-center gap-3 z-50 transition-all duration-300 ${scrolled ? 'h-12' : 'h-16'}`}>
          ...
          />
          <div className={`flex items-center tracking-widest font-bold ${scrolled ? 'text-xl' : 'text-2xl'} font-sans`}>
