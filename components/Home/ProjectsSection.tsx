...
const ProjectsSection: React.FC = () => {
  ...
  const projects = [
    { id: 1, title: t('projects.p1'), img: '/proj-1.webp', cat: 'Digital', url: '#' },
    { id: 2, title: t('projects.p2'), img: '/proj-2.webp', cat: 'Branding', url: '#' },
    { id: 5, title: t('projects.p5'), img: '/proj-5.webp', cat: 'Cleaning Tech', url: 'https://www.heltrent.no/' }, // Stable cleaning image
    { id: 6, title: 'GEO Performance', img: '/proj-6.webp', cat: 'AI Optimization', url: '#' },
    { id: 3, title: t('projects.p3'), img: '/proj-3.webp', cat: 'Development', url: '#' },
    { id: 4, title: t('projects.p4'), img: '/proj-4.webp', cat: 'Marketing', url: '#' },
  ];
